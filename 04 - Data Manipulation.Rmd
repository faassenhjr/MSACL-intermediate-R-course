...
batch_jan_timestamps <- batch_jan %>%
  mutate(batch_collected_timestamp = ymd_hms(batch_collected_timestamp),
         review_start_timestamp = ymd_hms(review_start_timestamp),
         review_complete_timestamp = ymd_hms(review_complete_timestamp)) %>%
  mutate(
